...
public class AdapterNativeInterface {
    ...
    /**
     * Obtem o ultimo valor de RSSI conhecido para um dispositivo conectado.
     * @param address Endereco MAC do dispositivo como array de bytes.
     * @return O valor do RSSI.
     */

    public native int getConnectedDeviceRssiNative(byte[] address); // shakka

    public native int getDisconnectionReasonNative(byte[] address); // shakka
