...
class ClassicShimAclConnection
 ...
 public:
  ...
  /* ======================== SHAKKA ======================================
  hands on bluetooth - trying to get rssi logs
  uncommented rssi variable and changed log_info
  */
  void OnReadRssiComplete(uint8_t rssi) override {
    // LOG_INFO("UNIMPLEMENTED");
    LOG_INFO("SHAKKA_LOG: OnReadRssiComplete -> rssi:%d", static_cast<int8_t>(rssi));
  // =================================================================
  }
